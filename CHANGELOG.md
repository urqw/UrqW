...
* Интерпретатор URQL:
	...
	+ Добавлено: системные переменные time, urqw_title, urqw_version и date (только при отсутствии специальных правил urq_mode).
	+ Добавлено: возможность задать значения системных переменных urqw_title и urq_mode при помощи файла manifest.json.
