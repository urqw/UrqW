...
* Инфраструктура разработки и сопровождения:
	...
	+ Изменено: Все подключённые отдельно .css файлы стилей и .js файлы скриптов теперь объединяются и минифицируются в один общий файл, подключаемый в продакшен-сборке движка единым пакетом.
	+ Изменено: Разработка веб-интерфейса теперь ведётся в файле index-dev.html, а файл index.html создаётся автоматически при сборке продакшен-версии движка.
