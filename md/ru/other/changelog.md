...
* Плеер игр:
	...
	+ Изменено: Области интерфейса для инвентаря, текста и кнопок выбора теперь перерисовываются только при изменении отображаемого содержимого, а не при каждом изменении состояния игры.
